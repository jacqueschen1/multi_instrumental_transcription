...
def train(args):
    ...
    for batch_data_dict in train_loader:    
        ...
        if iteration % 1000 == 0:
            ...
            plt.savefig('/local/CPSC532s_Results/MEL_RESULTS/Original_Mel/Attention_mel.png')
            fileData = open("/local/CPSC532s_Results/MEL_RESULTS/Original_Mel/Attention_mel.txt","a+") 
